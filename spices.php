...
?>
    ...
    <div class="ltn__product-area ltn__product-gutter mb-120 mt-70">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="product-details.html"><?php echo '<img src="includs/uploads/'.$row['Image'].'"  height="300px" width="300px" alt="user1">'?></a>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <button type="submit" class="btn theme-btn-2 btn-effect-1-- ">Cart</button>
                                            </div>
                                        </div>
                                    </div>
                                    <?php 
