                ...
                <div class="col-lg-12">
                    <div class="shoping-cart-inner">
                        <div class="shoping-cart-table table-responsive">
                            <table class="table">
                                <!-- <tr>
                                <td class="card-products-remove">Remove</td>
                                    <td class="cart-product-image">Image</td>
                                    <td class="cart-product-info">Product</td>
                                    <td class="cart-product-price">Price</td>
                                    <td class="cart-product-quantity">Quantity</td>
                                    <td class="cart-product-subtotal">Subtotal</td>
</tr> --> <?php cart_details(); ?>
