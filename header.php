...
?>
   <!-- HEADER AREA START (header-3) -->
    <header class="ltn__header-area ltn__header-3 section-bg-6">       
        ...
        <div class="ltn__header-middle-area">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="site-logo">
                            <a href="index.html"><img src="img/2.png" alt="Logo" height="70%" width="80%"></a>
                        </div>
                    </div>
                    ...
                    <button type="submit" name="goon"><i class="fas fa-search"></i></button>
                </form>
                            </div>
                        </div>
                    </div>
                                ...
                                <li>
                                    ...
                                    <div class="mini-cart-icon mini-cart-icon-2">
                                        <a href="#ltn__utilize-cart-menu" class="ltn__utilize-toggle">
                                            ...
                                            <h6><span>Your Cart</span> <span class="ltn__secondary-color">$<?php total_cart_price(); ?></span></h6>
                                        </a>
                                    </div>
                                </li>
                            </ul>
        ...
        <div class=" border header-bottom-area ltn__border-top ltn__header-sticky  ltn__sticky-bg-white ltn__primary-bg--- section-bg-1 menu-color-white--- d-none d-lg-block ">
            <div class="container ">
                <div class="row" >
  ...
  if(mysqli_num_rows($arrey)>0){
      ...
      while($row=mysqli_fetch_assoc($arrey)){   ?>   <li><a href="blog.html"><?php echo  $row['categories_name'];  ?></a></li><?php }}?>
        ...
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
          ...
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Dropdown
                    ...
                    <ul class="sub-menu">
                                                <li><a href="blog.html">spices</a></li>
                                                <li><a href="blog-grid.html">blended</a></li>
                                                <li><a href="blog-left-sidebar.html">instant mixing</a></li>
                                                <li><a href="blog-right-sidebar.html">hing</a></li>
                                                <li><a href="blog-details.html">other items</a></li>
                                            </ul>
                    </li>
                    <li><a href="#">PAGES</a>
