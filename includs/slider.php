...
<div class="input-group input-group-outline my-3">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="slideradd">Save changes</button>
      </div>
<form>
    </div>
  </div>
            ...
            <table class="table align-items-center mb-0">
              <thead>
                <tr>
                  ...
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">image1</th>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">image2</th>
              ...
              <tbody>
                ...
                if(mysqli_num_rows($arrey)>0){
                  while($row=mysqli_fetch_assoc($arrey)){
                   ?>     
                    ...
                    <div class="d-flex flex-column justify-content-center">
                        <h6 class=" text-sm"><?php echo  $row['slider_id'];  ?></h6>
                  ...
                  <td class="align-middle text-sm">
                    ...
                    <td>
                    <button  class="btn btn-danger"><a href="delete.php?slider_id=<?php echo $row['slider_id']; ?>" class="text-white">delete</button>
                  </td>
                </tr>
